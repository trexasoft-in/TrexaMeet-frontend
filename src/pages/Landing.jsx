    ...
    <div className="landing-page">
      ...
      <section className="lp-hero">
        <div className="lp-hero-badge">
          ...
          Simple meetings, done right.
        </div>
        <h1 className="lp-hero-title">
          Meet anyone,<br />
          <em className="lp-hero-title-em">anywhere.</em>
        </h1>
        ...
        <div className="lp-mock-ui">
          ...
          <div className="lp-mock-grid">
            {[
              { initials: 'S', name: 'Stuart', color: '#8B00C9', speaking: true },
              { initials: 'SG', name: 'Sanvi Grace', color: '#5B0085', speaking: false },
              { initials: 'LF', name: 'Leo Foster', color: '#7000A3', speaking: false },
            ].map((p, i) => (
      ...
      <div className="lp-proof-strip">
        {['Open access for participants', 'High-definition video & audio', 'Meet instantly'].map((text, i) => (
      ...
      <section className="lp-section" id="features">
        <div className="lp-section-eyebrow">Why TrexaMeet</div>
        <h2 className="lp-section-heading">Purpose-built for modern meetings.</h2>
        <p className="lp-section-desc">Everything you need for seamless meetings - without unnecessary complexity.</p>
        <div className="lp-features-grid">
          {[
            { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" /></svg>, title: 'Instant rooms', desc: 'Create a meeting in one click. No scheduling, no setup, no waiting.' },
            { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="23 7 16 12 23 17 23 7" /><rect x="1" y="5" width="15" height="14" rx="2" /></svg>, title: 'Guest-friendly', desc: 'Share a link and anyone can join - no account, no app download required.' },
            { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="3" width="20" height="14" rx="2" /><path d="M8 21h8M12 17v4" /><path d="M9 9l3-3 3 3M12 6v8" /></svg>, title: 'Crystal-clear video', desc: 'Adaptive video quality keeps calls smooth even on slower connections.' },
            { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>, title: 'Screen sharing', desc: 'Present your screen to everyone in the room with a single click.' },
            { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" /><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" /></svg>, title: 'Live chat', desc: 'Send messages and links during the call without interrupting the conversation.' },
            { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>, title: 'You\'re in control', desc: 'Mute participants, manage the room, and end the meeting whenever you\'re ready.' },
          ].map((f, i) => (
      ...
      <section className="lp-steps-section" id="how-it-works">
        <div className="lp-section">
          ...
          <h2 className="lp-section-heading">Up and running in seconds.</h2>
          <p className="lp-section-desc">No setup. No configuration. Just a link and a name.</p>
          <div className="lp-steps-grid">
            {[
              { n: '1', title: 'Create a room', desc: 'Sign in and hit "New Meeting". Your room is ready instantly.' },
              { n: '2', title: 'Share the link', desc: 'Copy the room link and send it - by message, email, or however you like.' },
              { n: '3', title: 'Anyone can join', desc: "Recipients click the link, type their name, and they're in. No account needed." },
              { n: '4', title: 'Meet', desc: "Video, audio, chat, screen share - everything is ready the moment you connect." },
            ].map((s, i) => (
